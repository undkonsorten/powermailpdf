...
if (!call_user_func_array('class_exists', $__tmp)) {
    ...
    //@@@@@@@@@
    	...
    	function FPDM() { 
		//==============
    		$this->FPDM_FILTERS=array(); //holds all supported filters
    		if(isset($this->FPDM_FILTERS)) array_push($this->FPDM_FILTERS,"ASCII85Decode");
    		if(isset($this->FPDM_FILTERS)) array_push($this->FPDM_FILTERS,"FlateDecode");
    		if(isset($this->FPDM_FILTERS)) array_push($this->FPDM_FILTERS,"ASCIIHexDecode");
    		if(isset($this->FPDM_FILTERS)) array_push($this->FPDM_FILTERS,"LZWDecode");
    		if(isset($this->FPDM_FILTERS)) array_push($this->FPDM_FILTERS,"Standard");
    		
    		$this->FPDM_REGEXPS= array(
    				"/Type"=>"/\/Type\s+\/(\w+)$/",
    				"/Subtype" =>"/^\/Subtype\s+\/(\w+)$/"
    		);
